<template>
  <div class="nav-ctn">
    ...
    <ul class="list-box">
      <li class="lists">
        <div class="main-link">
          <nuxt-link to="/homepage" class="text-box">
            <div class="home-svg">
          ...
          <div class="text-box show-text">
            <nuxt-link to="/homepage" class="text-in-box">
      ...
      <!-- <li class="lists">
        <div class="main-link">
          <nuxt-link to="/explore" class="text-box">
            <svg viewBox="0 0 24 24" aria-hidden="true" class="icon">
              <g>
                <path
          ...
          <div class="text-box show-text">
            <nuxt-link to="/explore" class="text-in-box">
      ...
      <li class="lists">
        <div class="main-link">
          <nuxt-link to="/notifications" class="text-box">
            <svg viewBox="0 0 24 24" aria-hidden="true" class="icon">
              <g>
                <path
      ...
      <li class="lists">
        <div class="main-link">
          <nuxt-link to="/messages" class="text-box">
            <svg viewBox="0 0 24 24" aria-hidden="true" class="icon">
              <g>
                <path
      ...
      <li class="lists">
        <div class="main-link">
          <nuxt-link to="/bookmark" class="text-box">
            <svg viewBox="0 0 24 24" aria-hidden="true" class="icon">
              <g>
                <path
          ...
          <div class="text-box show-text">
            <nuxt-link to="/bookmark" class="text-in-box">
      ...
      <li class="lists">
        <div class="main-link">
          <nuxt-link to="./profile" class="text-box">
            <svg viewBox="0 0 24 24" aria-hidden="true" class="icon">
              <g>
                <path
          ...
          <div class="text-box show-text">
            <nuxt-link to="/profile" class="text-in-box">
      ...
      <div dir="auto" class="tweet-button">
        <svg viewBox="0 0 24 24" aria-hidden="true" class="icon show-icon">
          <g>
            <path
        ...
        <span class="text show-text"> Tweet </span>
      </div>

      <div class="user">
        <div class="profle-pic">
          <img :src="profilePic" class="profile_pic" />
        </div>
...
.nav-ctn {
  ...
  box-shadow: inset -1px 0px 0px #e2e2ea37;
  overflow-x: hidden;
  z-index: 2;
  padding: 0 0rem;
}
