<template>
  <div class="main-container">
    ...
    <div class="leadingTweets">
      <Leading-Tweets :tweets="leadingTweetArray" />
    </div>
    <div class="user">
      ...
      leadingTweetArray: [
        {
          ...
          time: "20hrs",
          content:
            "This is a rad tweet cepoerfr7vyuhirt vg4yhrvh4 fy4uf84 f48g4u, Sometimes, giving the email a subject is harder than typing the email itself. Sometimes, giving the email a subject is harder than typing the email itself. Sometimes, giving the email a subject is harder than typing the email itself.",
          likes: 10,
          retweets: 12,
          comments: 10,
        },
